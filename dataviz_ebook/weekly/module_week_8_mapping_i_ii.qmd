...
# Install geopandas without fetching dependencies again
##await micropip.install('geopandas', deps=False)
import micropip
await micropip.install(['geopy', 'shapely'])
...
```{pyodide}
import micropip
# Install folium and its dependencies
...
# Create a simple map
m = folium.Map(location=[40.79, -77.86], zoom_start=13)
m
```
